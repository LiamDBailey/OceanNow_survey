...
systemfonts::register_font(name = "Montserrat100",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Thin.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-ExtraLight.ttf")
systemfonts::register_font(name = "Montserrat200",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-ExtraLight.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Light.ttf")
systemfonts::register_font(name = "Montserrat300",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Light.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Regular.ttf")
systemfonts::register_font(name = "Montserrat400",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Regular.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Medium.ttf")
systemfonts::register_font(name = "Montserrat500",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Medium.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-SemiBold.ttf")
systemfonts::register_font(name = "Montserrat600",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-SemiBold.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Bold.ttf")
systemfonts::register_font(name = "Montserrat700",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Bold.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-ExtraBold.ttf")
systemfonts::register_font(name = "Montserrat800",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-ExtraBold.ttf",
                           bold = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Black.ttf")
systemfonts::register_font(name = "Montserrat900",
                           plain = "C:\\Users\\remot\\AppData\\Local\\Microsoft\\Windows\\Fonts\\Montserrat-Black.ttf")
...
Key goals:
- Show that Q1-5 were heavily biased towards 'strongly agree' (for appendix if asked about analysis choice)
...
percentage_stronglyagree <- raw_data %>% 
  ...
  summarise(percentage = paste0(round((sum(value == 7)/n()) * 100), "%"))
...
plot <- raw_data %>% 
  {ggplot() +
      ...
      geom_text(data = percentage_stronglyagree,
                aes(x = QuestionNumber, y = 0.015, label = percentage),
                family = "Montserrat400", colour = "grey95") +
      labs(title = glue::glue("Majority of respondants answered <span style='color:{sig_colour}'>**strongly agree**</span>",
                              sig_colour = sig_colour),
