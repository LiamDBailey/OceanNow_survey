...
dictionary <- data.frame(name = c("Have you seen the exhibition?", "Haben Sie die Ausstellung schon besichtigt?",
                                  ...
                                  "By entering your email, you consent and confirm to receive the specified information from Ocean. Now!. For more info, check [our privacy policy](https://ocean-now.org/privacy-policy/) where you will get more info on where, how and why we store your data.",
                                  "Tragen Sie bitte dafür Ihre Emailadresse ein. Sie stimmen zu, dass Ocean. Now! Sie dafür kontaktieren darf. Für weitere Informationen lesen Sie bitte unsere [Datenschutzrichtlinien](https://ocean-now.org/de/datenschutzrichtlinie/)."),
